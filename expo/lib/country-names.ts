/**
 * ISO 3166-1 alpha-2 → English country name lookup, used to render the
 * country name (e.g. "Netherlands") next to the flag emoji on hunt cards.
 */
...
const COUNTRY_NAMES: Record<string, string> = {
  ...
  SS: 'South Sudan', ST: 'São Tomé and Príncipe', SV: 'El Salvador', SX: 'Sint Maarten', SY: 'Syria', SZ: 'Eswatini',
...
/**
 * Convert an ISO 3166-1 alpha-2 code to a full English country name.
 * Returns '' for null/invalid input, and falls back to the uppercase code
 * when a name is not in the map.
 */
